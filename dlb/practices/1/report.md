...
## Отчет "Прогнозирование качества вина"
...
4.  **Документация API (Swagger)**:
      ...
      * Эта спецификация может быть использована с любым онлайн-инструментом Swagger UI для интерактивного просмотра и тестирования API.
...
Полная спецификация API находится в файле `swagger_spec.json`.

Вы можете просмотреть интерактивную документацию Swagger UI, перейдя по ссылке (после того, как вы замените `ВАШ_НИКНЕЙМ` на свой GitHub-никнейм):

[https://htmlpreview.github.io/?https://github.com/paniccaaa/dlb/blob/main/practices/1/swagger\_spec.json
