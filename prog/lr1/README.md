...
# Функция для загрузки файлов и сохранения их в папку проекта
...
```sh
Пакет myremotemodule инициализирован
Adamenko Semyon's module is imported GIST GIST GIST
[<class 'zipimport.zipimporter'>, <function FileFinder.path_hook.<locals>.path_hook_for_FileFinder at 0x7c06d47a05e0>, <function url_hook at 0x7c06d3b809a0>]
```